...
describe('DataScreen', () => {
  it('renders a heading for each category', () => {
    ...
    render(<DataScreen cats={cats} onLogout={vi.fn()} onCreateCatalog={vi.fn().mockResolvedValue(undefined)} onCreateBidSheets={vi.fn().mockResolvedValue(undefined)} onCreateExpandedSheet={vi.fn().mockResolvedValue(undefined)} onLoadEmailData={vi.fn()} onReloadData={vi.fn()} />);
  ...
  it('renders no category headings when categories map is empty', () => {
    render(<DataScreen cats={new Map()} onLogout={vi.fn()} onCreateCatalog={vi.fn().mockResolvedValue(undefined)} onCreateBidSheets={vi.fn().mockResolvedValue(undefined)} onCreateExpandedSheet={vi.fn().mockResolvedValue(undefined)} onLoadEmailData={vi.fn()} onReloadData={vi.fn()} />);
  ...
  it('calls onLogout when the Logout button is clicked', async () => {
    ...
    render(<DataScreen cats={new Map()} onLogout={onLogout} onCreateCatalog={vi.fn().mockResolvedValue(undefined)} onCreateBidSheets={vi.fn().mockResolvedValue(undefined)} onCreateExpandedSheet={vi.fn().mockResolvedValue(undefined)} onLoadEmailData={vi.fn()} onReloadData={vi.fn()} />);
    await userEvent.click(screen.getByRole('button', { name: /logout/i }));
    expect(onLogout).toHaveBeenCalledOnce();
  });

  it('calls onCreateBidSheets when the Create Bid Sheets button is clicked', async () => {
    const onCreateBidSheets = vi.fn().mockResolvedValue(undefined);
    render(<DataScreen cats={new Map()} onLogout={vi.fn()} onCreateCatalog={vi.fn().mockResolvedValue(undefined)} onCreateBidSheets={onCreateBidSheets} onCreateExpandedSheet={vi.fn().mockResolvedValue(undefined)} onLoadEmailData={vi.fn()} onReloadData={vi.fn()} />);
    await userEvent.click(screen.getByRole('button', { name: /create bid sheets/i }));
    expect(onCreateBidSheets).toHaveBeenCalledOnce();
  });
});
