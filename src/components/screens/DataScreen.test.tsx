...
describe('DataScreen', () => {
  it('renders a heading for each category', () => {
    ...
    render(<DataScreen cats={cats} onLogout={vi.fn()} onCreateCatalog={vi.fn().mockResolvedValue(undefined)} onCreateBidSheets={vi.fn().mockResolvedValue(undefined)} />);
  ...
  it('renders no category headings when categories map is empty', () => {
    render(<DataScreen cats={new Map()} onLogout={vi.fn()} onCreateCatalog={vi.fn().mockResolvedValue(undefined)} onCreateBidSheets={vi.fn().mockResolvedValue(undefined)} />);
  ...
  it('calls onLogout when the Logout button is clicked', async () => {
    ...
    render(<DataScreen cats={new Map()} onLogout={onLogout} onCreateCatalog={vi.fn().mockResolvedValue(undefined)} onCreateBidSheets={vi.fn().mockResolvedValue(undefined)} />);
  ...
  it('calls onCreateBidSheets when the Create Bid Sheets button is clicked', async () => {
    ...
    render(<DataScreen cats={new Map()} onLogout={vi.fn()} onCreateCatalog={vi.fn().mockResolvedValue(undefined)} onCreateBidSheets={onCreateBidSheets} />);
